...
export class ModalGeneralService {
  ...
  async mensajeModalGeneral(datosModal: ModalInterface): Promise<boolean> {
    const respuestaModal = await Swal.fire({
      ...
      showCancelButton: datosModal.mostrarBotonCancelar
        ? datosModal.mostrarBotonCancelar
        : false,
      confirmButtonText: datosModal?.nombreBotonAceptar
        ? datosModal.nombreBotonAceptar
        : "Aceptar",
      cancelButtonText: datosModal?.nombreBotonCancelar
        ? datosModal?.nombreBotonCancelar
        : "Cancelar",
